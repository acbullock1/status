...
const dataSource = [
  ...
  },
  {
    ...
    component:'Ocean.com',
    number:'MGLN-7233',
    title:'OceanProfile - Pin Number - Cursor needs to automatically move to the next text field when user enters PIN Number on Portal and Payment page ',
    state:'QA IN PROGRESS',
    status:'looking at this today'
  }
...
let now = new Date(2018, 6, 17, 11, 55);
